...
Для выполнения задания рекомендуется создать в базе данных таблицу `farm` (Ферма) - поля `id (int), name (varchar), quantity(int), created_at(datetime)` (ид, наименование, количество, дата создания)  
